...
* **Dataset:** Curated compounds with reported caspase-3 activity obtained from [BindingDB](https://www.bindingdb.org/).
* **Models:**
...
![Model training curves](output.png)
...
This project uses TorchDrug for molecular graph representation, neural-network modeling, and molecular generation. Additional information is available in the [TorchDrug molecule-generation tutorial](https://torchdrug.ai/docs/tutorials/generation.html).
...
* [TorchDrug molecule-generation tutorial](https://torchdrug.ai/docs/tutorials/generation.html)
